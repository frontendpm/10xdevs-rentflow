  ...
  return (
    <Card
      className={`transition-all ${
        !readOnly ? "cursor-pointer hover:shadow-md hover:border-neutral-300 dark:hover:border-neutral-700" : ""
      }`}
      onClick={handleClick}
    >
      <CardHeader>
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <CardDescription className="mt-1">Termin płatności: {formatDate(charge.due_date)}</CardDescription>
          </div>
          <CardAction>
